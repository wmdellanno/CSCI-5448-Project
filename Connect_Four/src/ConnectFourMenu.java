/*@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
 ...
 Purpose: menu frame for connect four
 @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@*/
...
public class ConnectFourMenu extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == twoplayerBUT) { //two player game begins
            //System.out.println("Sorry this doesn't actually work...");
            //System.out.println("Click on the other button.");

            ConnectFourFrame frame = new ConnectFourFrame(false);
        ...
        } else { // autoplay game begins
            ConnectFourFrame frame = new ConnectFourFrame(true);
            frame.setSize(475, 450);
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.setTitle("Connect Four - AutoPlay Mode");
            this.setVisible(false);
            frame.setVisible(true);
        }
    }
